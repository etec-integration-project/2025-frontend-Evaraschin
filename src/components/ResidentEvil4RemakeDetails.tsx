...
const gameDetails = {
  ...
  ageRating: "18+",
  images: [
    "https://www.lavanguardia.com/files/content_image_desktop_filter/uploads/2022/06/03/62993e2303a2c.jpeg",
    "https://cdn.cloudflare.steamstatic.com/steam/apps/2050650/ss_1.jpg",
    "https://cdn.cloudflare.steamstatic.com/steam/apps/2050650/ss_2.jpg"
  ],
  requirements: {
    min: "Procesador: Intel Core i5-7500 / AMD Ryzen 3 1200, RAM: 8GB, GPU: GTX 1050 Ti / Radeon RX 560, Almacenamiento: 45GB",
    rec: "Procesador: Intel Core i7-8700 / AMD Ryzen 5 3600, RAM: 16GB, GPU: GTX 1070 / Radeon RX 5700, Almacenamiento: 45GB SSD"
  },
  rating: 4.9,
  releaseDate: "2023",
  developer: "Capcom",
...
const initialReviews = [
  { user: "Leon", rating: 5, comment: "El remake que todos esperábamos." },
  { user: "Ada", rating: 5, comment: "Tensión y acción mejoradas." },
  { user: "Chris", rating: 4, comment: "Visualmente impresionante." }
];

const tabs = ["Detalles", "Opiniones", "Más"];

const ResidentEvil4RemakeDetails: React.FC = () => {
...
export default ResidentEvil4RemakeDetails;
