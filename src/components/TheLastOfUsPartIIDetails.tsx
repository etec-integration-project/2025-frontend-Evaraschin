...
const gameDetails = {
  ...
  ageRating: "18+",
  images: [
    "https://www.infobae.com/resizer/v2/5GYJ5GJUXNBO5D2Z5JZOCLCK6U.jpg?auth=f8d9087ae42a3770e74296c8cd9c35c941e38c915bff88a93d7a627f765496f4&smart=true&width=700&height=394&quality=85",
    "https://cdn.cloudflare.steamstatic.com/steam/apps/1888930/ss_1.jpg",
    "https://cdn.cloudflare.steamstatic.com/steam/apps/1888930/ss_2.jpg"
  ],
  requirements: {
    min: "Procesador: Intel Core i5-2500K / AMD FX-6300, RAM: 8GB, GPU: GTX 760 / Radeon R9 280, Almacenamiento: 100GB",
    rec: "Procesador: Intel Core i7-4770K / AMD Ryzen 5 1500X, RAM: 16GB, GPU: GTX 1060 6GB / Radeon RX 480 4GB, Almacenamiento: 100GB SSD"
  },
  rating: 4.8,
  releaseDate: "2020",
...
const initialReviews = [
  { user: "Ana", rating: 5, comment: "Una obra maestra emocional." },
  { user: "Carlos", rating: 4, comment: "Historia impactante y jugabilidad excelente." },
  { user: "Sofía", rating: 5, comment: "Gráficos y narrativa de otro nivel." }
];

const tabs = ["Detalles", "Opiniones", "Más"];

const TheLastOfUsPartIIDetails: React.FC = () => {
...
export default TheLastOfUsPartIIDetails;
