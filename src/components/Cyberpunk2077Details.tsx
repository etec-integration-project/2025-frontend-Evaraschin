...
const gameDetails = {
  ...
  ageRating: "18+",
  images: [
    "https://cdn.forbes.com.mx/2023/08/Cyberpunk-2077-640x360.webp"
  ],
  requirements: {
    min: "Procesador: Intel Core i5-3570K / AMD FX-8310, RAM: 8GB, GPU: GTX 780 / RX 470, Almacenamiento: 70GB",
    rec: "Procesador: Intel Core i7-4790 / AMD Ryzen 3 3200G, RAM: 12GB, GPU: GTX 1060 / RX 590, Almacenamiento: 70GB SSD"
  },
  rating: 4.6,
  releaseDate: "2020",
...
const initialReviews = [
  { user: "Valen", rating: 5, comment: "Night City es increíble." },
  { user: "Agus", rating: 4, comment: "Mucho mejor después de los parches." },
  { user: "Mica", rating: 5, comment: "Historia atrapante y gran ambientación." },
];

const tabs = ["Detalles", "Opiniones", "Más"];

const Cyberpunk2077Details: React.FC = () => {
...
export default Cyberpunk2077Details;
