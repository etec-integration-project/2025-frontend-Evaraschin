...
const gameDetails = {
  ...
  ageRating: "18+",
  images: [
    "https://imgmedia.larepublica.pe/640x371/larepublica/original/2022/01/14/61e1cdc8f4cb332c1374e01a.webp",
    "https://cdn.cloudflare.steamstatic.com/steam/apps/2208920/ss_1.jpg",
    "https://cdn.cloudflare.steamstatic.com/steam/apps/2208920/ss_2.jpg"
  ],
  requirements: {
    min: "Procesador: Intel Core i5-4460 / AMD Ryzen 3 1200, RAM: 8GB, GPU: GTX 960 / Radeon R9 380, Almacenamiento: 50GB",
    rec: "Procesador: Intel Core i7-6700 / AMD Ryzen 7 1700, RAM: 16GB, GPU: GTX 1080 / Radeon RX Vega 64, Almacenamiento: 50GB SSD"
  },
  rating: 4.7,
  releaseDate: "2020",
  developer: "Ubisoft",
...
const initialReviews = [
  { user: "Erik", rating: 5, comment: "La mejor entrega de la saga." },
  { user: "Valeria", rating: 4, comment: "Gran ambientación y combate." },
  { user: "Oscar", rating: 5, comment: "Exploración y narrativa excelentes." }
];

const tabs = ["Detalles", "Opiniones", "Más"];

const AssassinsCreedValhallaDetails: React.FC = () => {
...
export default AssassinsCreedValhallaDetails;
