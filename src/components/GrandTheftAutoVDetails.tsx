...
const gameDetails = {
  ...
  ageRating: "18+",
  images: [
    "https://play-reactor.com/wp-content/uploads/2013/04/grand_theft_auto_v_1.jpg?w=470&h=578"
  ],
  requirements: {
    min: "Procesador: Intel Core 2 Quad CPU Q6600 / AMD Phenom 9850, RAM: 4GB, GPU: NVIDIA 9800 GT 1GB / AMD HD 4870 1GB, Almacenamiento: 72GB",
    rec: "Procesador: Intel Core i5 3470 / AMD X8 FX-8350, RAM: 8GB, GPU: NVIDIA GTX 660 2GB / AMD HD 7870 2GB, Almacenamiento: 72GB SSD"
  },
  rating: 4.9,
  releaseDate: "2013",
...
const initialReviews = [
  { user: "Mauro", rating: 5, comment: "El mejor sandbox de la historia." },
  { user: "Sofía", rating: 5, comment: "Horas y horas de diversión." },
  { user: "Leo", rating: 4, comment: "Online muy entretenido." },
];

const tabs = ["Detalles", "Opiniones", "Más"];

const GrandTheftAutoVDetails: React.FC = () => {
...
export default GrandTheftAutoVDetails;
